package com.uniovi.sdi2425509spring;

import com.uniovi.sdi2425509spring.pageobjects.*;
...
class Sdi2425509SpringApplicationTests {
	static String PathFirefox = "C:\\Program Files\\Mozilla Firefox\\firefox.exe";
	//static String Geckodriver = "C:\\Path\\geckodriver-v0.30.0-win64.exe";
	//static String Geckodriver = "C:\\Dev\\tools\\selenium\\geckodriver-v0.30.0-win64.exe";
	//static String PathFirefox = "/Applications/Firefox.app/Contents/MacOS/firefox-bin";
	//static String Geckodriver = "C:\\Users\\Usuario\\Downloads\\sesion06\\sesion06\\PL-SDI-Sesión6-material\\PL-SDI-Sesión5-material\\geckodriver.exe";
	static String Geckodriver = "C:\\Users\\UO295662\\Downloads\\PL-SDI-Sesión6-material\\PL-SDI-Sesión5-material\\geckodriver.exe";
...
// Propiedad: Error.signup.dni.length
	...
	public void PR14() {
		...
		PO_PrivateView.check(driver,"//*[@id='myNavbar']/ul[1]/li[2]",0);
		...
		//elements.get(0).click();
		PO_PrivateView.check(driver,"//a[contains(@href, 'mark/add')]",0);
		...
		PO_PrivateView.check(driver,"//a[contains(@class, 'page-link')]",4);
	...
	public void PR15() {
		...
		//elements.get(0).click();
		PO_PrivateView.check(driver,"//a[contains(@href, 'mark/list')]",0);
		...
		//elements.get(0).click();
		PO_PrivateView.check(driver,"//td[contains(text(), 'Nota sistemas distribuidos')]/following-sibling::*/a[contains(@href, 'mark/delete')]",0);
		...
		//Ahora nos desconectamos comprobamos que aparece el menú de registrars
	...
	public void PR16() {
		...
		PO_PrivateView.check(driver,"//*[@id='myNavbar']/ul[1]/li[4]",0);
		PO_PrivateView.check(driver,"//a[contains(@href, 'professor/add')]",0);
		PO_PrivateView.fillFormAddProfessor(driver,"123456758A","Manuel","Perez","Matemáticas");
		PO_PrivateView.logout(driver);
	}
}